...
function wpgmaps_tag_pro( $atts ) {
	...
	if(!empty($wpgmza->settings->wpgmza_gdpr_enabled) && !empty($wpgmza->settings->wpgmza_gdpr_require_consent_before_load) && !isset($_COOKIE['wpgmza-api-consent-given']))
	{
